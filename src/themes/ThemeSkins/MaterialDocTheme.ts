...
import { createTheme, ThemeOptions, Theme, PaletteColor, responsiveFontSizes } from '@mui/material/styles';
...
export const CreateResponsiveFontSizesTheme=(themeOptions: ThemeOptions,...args: object[]):Theme=>{
  const themeObject=createTheme(themeOptions,zhCN,...args);
  const theme=responsiveFontSizes(createTheme(themeOptions, GetThemedComponents(themeObject),zhCN,...args));
  return theme;
}